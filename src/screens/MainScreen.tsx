...
const MainScreen: React.FC = () => {
  ...
  const saveStepsToHealthConnect = async () => {
    ...
    // if (!healthConnectReady || currentSteps === 0 || !startTime) {
    ...
    try {
      ...
      //     startTime: startTime, // ✅ when tracking began
      //     endTime: endTime, // ✅ now
      //   };
      const stepRecord = {
        recordType: 'Steps',
        count: 523, // number of steps during the interval
        startTime: '2025-09-25T10:00:00.000Z', // when tracking began
        endTime: '2025-09-25T10:15:00.000Z', // when tracking ended
      };

      console.log('stepRecord to insert:', stepRecord);
